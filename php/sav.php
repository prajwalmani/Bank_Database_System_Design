...
$query = "INSERT INTO `account` (`account`, `balance`, `last_accessed_date`, `account_type`, `intereset_overdraft`, `cssn`, `Branch_id`) VALUES ('$accno', $deposit, '$d', 's', '0.2', '$ssn', '1');";

$query2 = "INSERT INTO `savings` (`savingsaccount`, `last_accessed_date`, `savings_interset_rate`) VALUES ('$accno', '$d', '0.2');";
