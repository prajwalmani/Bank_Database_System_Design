...
$query = "INSERT INTO `account` (`account`, `balance`, `last_accessed_date`, `account_type`, `intereset_overdraft`, `cssn`, `Branch_id`) VALUES ('$accno', $deposit, '$d', 'm', '8', '$ssn', '1');";

$query2 = "INSERT INTO `moneymarket` (`marketaccount`, `updated_date`, `market_interset_rate`) VALUES ('$accno', '$d', '8');";
