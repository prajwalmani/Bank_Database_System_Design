...
$query = "INSERT INTO `account` (`account`, `balance`, `last_accessed_date`, `account_type`, `intereset_overdraft`, `cssn`, `Branch_id`) VALUES ('$accno', $totalloan, '$d', 'l', '9', '$ssn', '1');";

$query2 = "INSERT INTO `loan` (`loan`,`amount`,`repayment_amount`,`interset_rate`,`account`) VALUES ('$accno',$totalloan,0,9,'$lsa');";
